    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(System.in)) {
            ...
            switch (fruit) {                             // switch and pass an argument/ variable in it
                ...
                // put break so that if satisfied it does not go ahead and save time
                case "Orange" -> System.out.println("orange fruit");
                case "Jackfruit" -> System.out.println("big fruit");
                default -> System.out.println("invalid name");      // no need of break after this default statement
}
            // switch and pass an argument/ variable in it
        }
        }}   
